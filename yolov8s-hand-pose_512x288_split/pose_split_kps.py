"""Cut YOLOv8s-pose detect/DFL decode and split 21-keypoint heads into xy / score.

Same graph surgery as yolov8n-hand-pose_512x288_split/pose_split_kps.py.
YOLOv8 detect head is still typically /model.22/cv*.2/Conv_output_0.
"""
import numpy as np
import onnx
...
if __name__ == "__main__":
    file_in = "yolov8s-hand-pose.onnx"
    file_cut = "yolov8s-hand-pose_cut.onnx"
    file_out = "yolov8s-hand-pose_edit.onnx"
